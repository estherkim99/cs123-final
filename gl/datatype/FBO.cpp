    ...
    m_height(height)
{
    ...
    generateDepthStencilAttachment(); // should create depth texture?

    // This will make sure your framebuffer was generated correctly!
    checkFramebufferStatus(); // checks status
...
void FBO::generateDepthStencilAttachment() {
    switch(m_depthStencilAttachmentType) {
        ...
        case DEPTH_STENCIL_ATTACHMENT::DEPTH_STENCIL:
            ...
            // TODO:
            // below is all done with Texture2D, but may need actual data??
//            GLuint depthTexture;
//            glGenTextures();
//            glBindTexture();
//            glTexImage2D();
